...
import { resetFormData, setBusy, setFormData, setToast } from 'store/slices/appSlice';
...
const _data = {
    "resultList": [
            ...
            "data": [
                {
                    ...
                    "oppdateringsdato": "2026-04-02T01:31:09.015",
                    "opphav": "Kartverket"
                }
            ],
            "themes": [
        ...
        },
        {
            ...
            "hitArea": null,
            "resultStatus": "NO-HIT-GREEN",
            "distanceToObject": 9223372036854775807,
            "rasterResult": {
                "imageUri": null,
                "mapUri": null
            },
        ...
        },
        {
            ...
            "runAlgorithm": [
                ...
                "intersects layer FlomAktsomhetOmr (Error)"
            ],
            "inputGeometryArea": null,
            "hitArea": null,
            "resultStatus": "ERROR",
        ...
        },
        {
            ...
            "runOnDataset": {
                ...
                "description": "Datasettet viser områder som er kartlagt og verdsatt etter metodikken i Miljødirektoratets Veileder M98-2013 (Tidligere DN håndbok 25 – 2004 Kartlegging og verdsetting av friluftslivsområder). Datasettet skal gi en oversikt over områder som er viktige for allmennhetens friluftsliv, og informasjonen i datasettet skal gjøre det lett å se hvilke vurderinger og kriterier som er lagt til grunn for arbeidet og det ferdige produktet.",
                "owner": "Miljødirektoratet",
                "updated": "2021-01-01T00:00:00",
